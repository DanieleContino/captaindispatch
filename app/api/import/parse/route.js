...
- If the document is a travel calendar or movement schedule with columns like position/role, name, p/up dep, from, time, to, travel number, p/up arr, accommodation — detect it as type 'travel'.
...
Return format:
{
  "type": "crew" | "fleet" | "accommodation" | "mixed" | "travel",
  "crew": [...],
  "vehicles": [...],
  "accommodation": [],
  "travel": []
...
async function processTravelRows(rawRows, supabase, productionId) {
  ...
  const rows = rawRows.map((raw, i) => {
    ...
    return {
      ...
      _idx: i,
      action: 'insert',
      existingId: match?.uuid || null,
      match_status: matchStatus,
      direction,
      hub_location_id: hubMatch.uuid,
      hotel_id,
      hotelNotFound,
