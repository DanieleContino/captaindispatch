...
function CrewInfoMiniModal({ member, locsMap, onClose }) {
  ...
  useEffect(() => {
    ...
    Promise.all([
      supabase.from('crew')
        .select('uuid,display_id,full_name,role,department,phone,email,hotel_id,arrival_date,departure_date,no_transport_needed')
...
export default function PaxCoveragePage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f1f5f9' }}>
      ...
      <div style={{ background: 'white', borderBottom: '1px solid #e2e8f0', padding: '8px 16px', minHeight: '52px', height: 'auto', display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap', position: 'sticky', top: '0px', zIndex: 21 }}>
      ...
      <div style={{ background: 'white', borderBottom: '1px solid #e2e8f0', padding: '8px 16px', minHeight: '52px', height: 'auto', display: 'flex', alignItems: 'center', gap: '6px', position: 'sticky', top: '52px', zIndex: 20, flexWrap: 'wrap' }}>
        {/* Show only toggle */}
