...
export const TRIP_COLS = [
  ...
  { key: 'trip',      label: 'TRIP',       width: '110px' },
  { key: 'vehicle',   label: 'VEHICLE',    width: '240px' },
  { key: 'route',     label: 'ROUTE',      width: '380px' },
  { key: 'pax',       label: 'PASSENGERS', width: '280px' },
  { key: 'pax_count', label: 'PAX',        width: '60px'  },
]
