...
export const ACCOMMODATION_COLUMNS_CATALOG = {
  ...
  room_type_notes:    { label: 'Room Type',     defaultWidth: '160px' },
  ...
  booking_status:     { label: 'Booking Status', defaultWidth: '110px' },
  ...
  sharing_with:       { label: 'Sharing with',  defaultWidth: '160px' },
  extras:             { label: 'Extras',         defaultWidth: '160px' },
}
...
export const ACCOMMODATION_DEFAULT_PRESET = [
  ...
  { source_field: 'room_type_notes', header_label: 'Room Type',   width: '160px', display_order: 40  },
  ...
  { source_field: 'extras',          header_label: 'Extras',      width: '160px', display_order: 100 },
]
