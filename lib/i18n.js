...
const translations = {
  ...
  en: {
    ...
    deleteSelectedCrew:        '🗑 Delete selected',
    selectedCrewCount:         'selected',
    cancelCrewSelection:       '✕ Cancel selection',
    deleteSelectedCrewConfirm: '⚠ Are you sure? This will permanently delete {n} crew member(s).',
    selectAllCrew:             'Select all',
    ...
    noCrewStatus:        'No crew — check Travel_Status (PRESENT)',
    ...
    locTypeHotel:            '🏨 Hotel / Set',
    locTypeAirport:          '✈️ Airport',
    locTypeStation:          '🚂 Station',
    locTypePort:             '⚓ Port',
    locTypeHotelHint:        'Hotel, set, basecamp or generic location',
    locTypeAirportHint:      'Airport hub — used for transfer class',
    locTypeStationHint:      'Train station hub',
    locTypePortHint:         'Port / Ferry terminal hub',
    iataCodeLabel:           'IATA Code',
    iataCodePlaceholder:     'PMO',
    iataCodeHint:            'Airport 3-letter code (e.g. PMO, FCO, MXP)',
    locIdPreview:            'Generated ID',
  ...
  it: {
    ...
    deleteSelectedCrew:        '🗑 Elimina selezionati',
    selectedCrewCount:         'selezionati',
    cancelCrewSelection:       '✕ Annulla selezione',
    deleteSelectedCrewConfirm: '⚠ Sicuro? Verranno eliminati {n} membro/i del crew definitivamente.',
    selectAllCrew:             'Seleziona tutti',
    ...
    locTypeLabel:            'Tipo location',
    locTypeHotel:            '🏨 Hotel / Set',
    locTypeAirport:          '✈️ Aeroporto',
    locTypeStation:          '🚂 Stazione',
    locTypePort:             '⚓ Porto',
    locTypeHotelHint:        'Hotel, set, campobase o location generica',
    locTypeAirportHint:      'Hub aeroporto — usato per transfer class',
    locTypeStationHint:      'Hub stazione ferroviaria',
    locTypePortHint:         'Hub porto / terminal traghetti',
    iataCodeLabel:           'Codice IATA',
    iataCodePlaceholder:     'PMO',
    iataCodeHint:            'Codice aeroporto a 3 lettere (es. PMO, FCO, MXP)',
    locIdPreview:            'ID generato',
