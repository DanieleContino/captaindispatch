...
export const NAV_ITEMS = [
  ...
  { l: 'Fleet Monitor', p: '/dashboard/fleet' },
...
export function Navbar({ currentPath, className }) {
  ...
  return (
    <>
      ...
      <div className={className} style={{ background: '#0f2340', padding: '0 24px', paddingTop: 'env(safe-area-inset-top)', height: 'calc(52px + env(safe-area-inset-top))', display: isMobile ? 'none' : 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 30 }}>
      ...
      {isMobile && (
        <div style={{ background: '#0f2340', padding: '0 16px', paddingTop: 'env(safe-area-inset-top)', height: 'calc(52px + env(safe-area-inset-top))', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 30 }}>
      ...
      {isMobile && moreOpen && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 200, background: '#0f2340', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
          {/* Drawer header */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 16px', paddingTop: 'env(safe-area-inset-top)', height: 'calc(52px + env(safe-area-inset-top))', borderBottom: '1px solid #1e3a5f', flexShrink: 0 }}>
          ...
          <div style={{ padding: '12px 12px', display: 'flex', flexDirection: 'column', gap: '4px', flex: 1 }}>
            {/* Mode switcher links — mobile (hidden for restricted roles) */}
            {!isRestricted && (
