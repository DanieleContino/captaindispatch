...
// ─── Sortable block row ──────────────────────────────────────
function SortableBlockRow({ block, isExpanded, onToggle, onDelete, onPatch, productionId }) {
  const {
...
function ZoneSection({ zone, blocks, expandedId, setExpandedId, onReorder, onAdd, onDelete, onPatch, productionId }) {
